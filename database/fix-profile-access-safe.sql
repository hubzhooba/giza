-- Fix profile access for room participants (SAFE VERSION)
-- This ensures that users can see profile information of other participants in their rooms

-- =====================================================
-- STEP 1: SAFELY UPDATE PROFILE POLICIES
-- =====================================================

-- Drop ALL existing profile policies first
DROP POLICY IF EXISTS "Users can view their own profile" ON public.profiles;
DROP POLICY IF EXISTS "Users can view profiles of room participants" ON public.profiles;
DROP POLICY IF EXISTS "Users can update their own profile" ON public.profiles;
DROP POLICY IF EXISTS "Users can insert their own profile" ON public.profiles;

-- Create new comprehensive policy for viewing profiles
