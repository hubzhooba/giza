-- Complete Database Setup for Giza Contract Platform
-- Run this in your Supabase SQL Editor

-- Enable UUID extension
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- 1. Create profiles table first (needed for foreign keys)
...
-- 2. Create rooms table with all necessary columns
...
-- 7. Create RPC function for getting room data (for invite links)
...
-- 8. Create function to join a room
